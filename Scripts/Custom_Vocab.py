...
mathematics_vocab = [
    ...
    "limits", "differentiation", "continuity", "optimisation", "infinitesimals", "mean", "median", "mode", "variance", 
    ...
    "exponents", "probability theory", "combinatorics", "statistics", "factorisation", "set theory", "graph theory", "permutations", 
...
english_vocab = [
    ...
    "writing conventions", "text features", "structure", "organisation", "academic writing", "proofreading", "editing", "summarisation", 
...
humanities_vocab = [
    ...
    "human development", "consciousness", "neuroscience", "human rights", "culture", "deviance", "socialisation", "gender studies", 
    "class systems", "inequality", "race and ethnicity", "moral philosophy", "political ideologies", "democracy", "authoritarianism", 
    "feminism", "post-colonialism", "globalisation", "global warming", "colonialism", "indigenous rights", "cultural anthropology", 
...
business_and_law_vocab = [
    ...
    "corporate responsibility", "globalisation", "global finance", "financial markets", "trade law", "taxation", "public policy", 
